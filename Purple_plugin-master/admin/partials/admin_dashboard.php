...
<div class="custom-dashboard">
            ...
            <a href="/wp-admin/edit.php?post_type=article" class="dashboard-page-links">
                <div class="dashboard-card-body">
                    ...
                    <div class="item-icon_des">
                        <span class="wp-menu-image dashicons-before dashicons-media-document" aria-hidden="true">No. of
                            Articles</span>
                    </div>
                </div>
            </a>
        ...
        <div class="dashboard-cards col-4">
            <a href="/wp-admin/admin.php?page=plan" class="dashboard-page-links">
                <div class="dashboard-card-body">
                    ...
                    <div class="item-icon_des">
                        <span class="wp-menu-image dashicons-before dashicons-editor-ul" aria-hidden="true">No. of
                            Plans</span>
                    </div>
                </div>
            </a>
            ...
            <div class="dashboard-cards col-4">
                <a href="/wp-admin/admin.php?page=email-logs" class="dashboard-page-links">
                    <div class="dashboard-card-body">
                        ...
                        <div class="item-icon_des">
                            <span class="wp-menu-image dashicons-before dashicons-email-alt" aria-hidden="true">No. of
                                Workflow Emails</span>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="dashboard-cards col-4">
            <a href="/wp-admin/admin.php?page=library" class="dashboard-page-links">
                <div class="dashboard-card-body">
                    ...
                    <div class="item-icon_des">
                        <span class="wp-menu-image dashicons-before dashicons-book-alt" aria-hidden="true">No. of Media
                            files on Library</span>
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="calendar-dashboard-widget user-management-header">
        ...
        foreach ($all_users as $user) {
            ...
            // ($is_active) ? $stat = '<i class="fas fa-circle text-active"></i>Active' : $stat = '<i class="fas fa-circle text-inactive"></i>Inactive';
            if ($last_login_date) {

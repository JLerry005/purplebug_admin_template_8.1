    ...
    <div class="add-new-user-modal">
        <div class="modal add-user-modal" style="display:block;">
            <form action="#" method="post" id="add-user-modal">
                <div class="plan-CreateModal-title ">
                    <h1 class="user-modal-title">Add new User</h1>
                </div>
                <input type="hidden" name="user-id" id="user-hidden-id" value="">
                <div class="form-group">
                    <label id="username-label">Username * </label>
                    <input name="username" required id="username" autocomplete="off" class="input-field show-tooltip"
                        maxlength="80" type="text" placeholder="Enter Username" value="">

                </div>
                <div class="form-group">
                    <label>User Email *
                        <input name="email" required autocomplete="off" id="email" class="input-field" maxlength="80"
                            type="email" placeholder="Enter Email" value="">
                    </label>
                </div>
                <div class="form-group">
                    <label>User Role *
                ...
                <a href="#" class="change-pass-switch">
                    <p>Change password</p>
                </a>
                <div class="form-group change-password" style="display:none;">
                    <label class="validate-password">Set New Password * </label>
                    <input name="set_new_password" id="set_new_password" autocomplete="off" class="input-field"
                        maxlength="80" type="text" placeholder="Set New Password" value="">

                </div>
                <div class="form-group " style="display:none;">
                    <label>Password *
                        <input name="new_password" id="new_password" autocomplete="off" class="input-field"
                            maxlength="80" type="text" placeholder="Type your Password" value="">
                    </label>
                </div>
                ...
                <div class="create-user-button">
                    <div class="inner-buttons">
                        <a class="close cls-user-btn ndl-Button ndl-Button--primary ndl-Button--medium"
                            href="#">Close</a>

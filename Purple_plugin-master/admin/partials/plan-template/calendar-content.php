<div class="result">
    <div class="cal-header">
        <div class="ndl-GridItem ndl-GridItem--alignLeft plan-VisualCalendarHeader-leftActions" data-size="5">
                                    ...
                                    <i class="nc-icon-wrapper">
                                        <svg viewBox="0 0 16 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g id="UI" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g id="16" transform="translate(-217.000000, -399.000000)"
                                                    fill="#444444">
                                                    <path
            ...
            <button class="ndl-Button ndl-Button--default ndl-Button--medium plan-VisualCalendarHeader-todayButton"
                type="button"><span class="ndl-Button-label">Today</span></button>
            <button class="min-date ndl-Button ndl-Button--secondaryAlt ndl-Button--medium ndl-Button--iconOnly"
                type="button">
                    ...
                    <i class="nc-icon-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                            ...
                            <g transform="translate(0, 0)">
                                <polygon fill="#444444" points="11.1,15.7 3.4,8 11.1,0.3 12.6,1.7 6.3,8 12.6,14.3 ">
                                </polygon>
                            </g>
                        </svg>
                    </i>
            ...
            <button class="add-date ndl-Button ndl-Button--secondaryAlt ndl-Button--medium ndl-Button--iconOnly"
                type="button">
                <span class="nc-icon ndl-Icon ndl-Button-icon">
                    <i class="nc-icon-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                            y="0px" viewBox="0 0 16 16">
                            <g transform="translate(0, 0)">
                                <polygon fill="#444444" points="4.9,15.7 3.4,14.3 9.7,8 3.4,1.7 4.9,0.3 12.6,8 ">
                                </polygon>
                            </g>
                        </svg>
                    </i>
    ...
    <style>
        ...
        .plan-VisualCalendarHeader-leftActions .ndl-SearchBar-collapsed {
            position: relative;
            padding-right: 20px;
            /* max-width: 60px; */
        }
    ...
    if (!empty($workflows)) {
        foreach ($workflows as $workflow) {
            $w_titles[] = $workflow->post_title;
        }
    }

    $w_tojson = json_encode($w_titles, JSON_THROW_ON_ERROR, 512);
                                        ...
                                        this._on(this.input, {
                                            autocompleteselect: function (event, ui) {
                                                ...
                                                jQuery.ajax({
                                                    ...
                                                    data: {
                                                        action: 'get_workflow', workflow: ui.item.option.outerHTML.split('"')[1]
    ...
    <div id="create-task" class="modal">
        <form id="creat-task-form" method="POST">
            <header class="ndl-Header ndl-Header--section ndl-Modal-header">
                <h1 class="ndl-HeaderTitle ndl-HeaderTitle--section ndl-HeaderTitle--medium undefined">
                    <div class="plan-CreateModal-title">Create New Task</div>
                </h1>
            </header>
            <div class="form-group">
                <input name="task-title" autocomplete="off" required class="input-field task-title-count" maxlength="80"
                    type="text" placeholder="Enter task title here" value="" />
            ...
            <div class="form-group">
                <div class="ui-widget">
                    <label>Workflow
                        ...
                        <input id="workflow_id" name="workflow_id" type="hidden" placeholder="" class="input-field"
                            value="" />
                    </label>
                </div>
            ...
            <div class="form-group">
                <label>
                    Task Due Date *
                    <input required id="task-due-date" name="task_end_date" autocomplete="off" type="text"
                        placeholder="" class="input-field ndl-DatePicker-input" value="" />
                    <input id="task_start_date" name="task_start_date" type="hidden" placeholder=""
                        class="input-field ndl-DatePicker-input" value="" />
                </label>
            </div>
            ...
            <div class="create-task-button">
                <div class="inner-buttons">
                    ...
                    <a class="close ndl-Button ndl-Button--primary ndl-Button--medium" href="#"
    ...
    <div id="create-event" class="modal">
        <form id="create-event-form" method="POST">
            <header class="ndl-Header ndl-Header--section ndl-Modal-header">
                <h1 class="ndl-HeaderTitle ndl-HeaderTitle--section ndl-HeaderTitle--medium undefined">
                    <div class="plan-CreateModal-title">Create New Event</div>
                </h1>
            </header>
            <div class="form-group">
                <input name="task-title" autocomplete="off" required class="input-field task-title-count" maxlength="80"
                    type="text" placeholder="Add Event Name" value="" />
                <p class="ndl-Text ndl-Text--secondary ndl-Input-charCount ndl-CharacterCount">0/80</p>
            </div>
            <div class="form-group">
                <label>
                    Event Description *
                    <div name="event-secription" required
                        class="ndl-TextArea ndl-TextArea--isResizeable ndl-FormControl-field">
                        <textarea class="ndl-TextArea-field" maxlength="250"
            ...
            <div class="form-group date-picker">
                <div class="form-field right">
                    <label>
                        End Date *
                        <input id="event-due-date" autocomplete="off" required name="task_end_date" type="text"
                            placeholder="" class="input-field ndl-DatePicker-input" value="" />
                        <input id="task_start_date-event" name="task_start_date" type="hidden" placeholder=""
                            class="date input-field ndl-DatePicker-input" value="" />
                    </label>
                </div>
            </div>
